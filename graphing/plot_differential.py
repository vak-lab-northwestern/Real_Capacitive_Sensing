...
def plot_differential_data():
    # File path
    csv_file = "differential_capacitance_20250917_175819.csv"
    ...
    try:
        ...
        plt.plot(df['timestamp'], df['CH0_pF'], 
                linewidth=1.5, alpha=0.8, color='blue', label='CH0 Capacitance')
        
        # Customize the plot
        plt.xlabel('Time (s)', fontsize=12)
        plt.ylabel('Capacitance (pF)', fontsize=12)
        plt.title('Differential Capacitance - CH0 vs Time', fontsize=14, fontweight='bold')
