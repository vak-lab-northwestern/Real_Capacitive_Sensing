...
print("[INFO] GUI initialized. Click 'Start Logging' to begin.")
...
def start_logging(event):
    ...
    fname = "20250801_x4_PVDF_patch_capacitance_test2.csv"
    try:
            ...
            if logging_enabled and csv_writer and csv_file:
                ...
                with log_lock:
                    try:
                        ...
                        csv_file.flush()
                        print(f"[DEBUG] Wrote: {timestamp:.2f}s, {caps[0]:.2f}pF")
                    except Exception as e:
